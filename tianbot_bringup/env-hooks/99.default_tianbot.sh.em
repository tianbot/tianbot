...
: ${TIANBOT_BASE:=tianbot_omni}  #tianbot_omni, tianbot_diff, tianrover, tianbot_mini.
: ${TIANBOT_BASE_MODEL:=06q1}  #06q1, 08q1, 08q2, 08q8, etc
: ${TIANBOT_BASE_PORT:=/dev/tianbot_base}  # /dev/ttyUSB1
: ${TIANBOT_BASE_BAUDRATE:=460800}  # /dev/ttyUSB1
: ${TIANBOT_RGBD_CAMERA:=none} #realsense_d415, realsense_d435, astra, astra_pro, xtion, zed,zed2, zed2i, none 
...
: ${TIANBOT_LIDAR:=osight_lidar} # rplidar_a1, rplidar_a2, rplidar_a3, osight_lidar, velodyne_vlp16, richbeam_lidar
