...
: ${TIANBOT_RGBD_CAMERA:=astra} #realsense_d415, realsense_d435, astra, astra_pro, xtion, none 
: ${TIANBOT_VIDEO_DEVICE:=/dev/video0} # /dev/video0 for most of the usb_cams.If you want init usb_cam in jet_cam, this should be set to none.
