...
def generate_launch_description():
    # os env variable
    serial_port = os.environ.get("TIANBOT_BASE_PORT", "/dev/tianbot_base")
    serial_baudrate = os.environ.get("TIANBOT_BASE_BAUDRATE", "115200")
    
    pkg_share = get_package_share_directory("tianbot_core")
