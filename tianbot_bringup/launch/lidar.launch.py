...
def generate_launch_description():
    lidar = os.environ.get("TIANBOT_LIDAR", "rplidar_a1")
    model = os.environ.get("TIANBOT_LIDAR_MODEL", "a1")
    serial_port = os.environ.get("TIANBOT_LIDAR_PORT", "/dev/tianbot_lidar")
    lidar_ip = os.environ.get("TIANBOT_LIDAR_IP", "192.168.198.1")
