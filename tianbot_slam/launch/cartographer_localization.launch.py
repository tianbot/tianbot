...
def generate_launch_description():
    ...
    cartographer_node = Node(
        ...
        arguments = [
            '-configuration_directory', FindPackageShare('tianbot_slam').find('tianbot_slam') + '/param',
            '-configuration_basename', '2d_scan_localization.lua',
            '-load_state_filename', '/home/tianbot/tianbot_ros2_ws/src/tianbot/tianbot_navigation2/pbstreams/tianbotoffice_603.pbstream'
            ],
        remappings = [
            ('scan', 'scan'),
            ('imu', 'imu'),
