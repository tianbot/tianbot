...
local robot_name  = os.getenv("TIANBOT_NAME") or "tianbot"
...
options = {
  ...
  map_frame = robot_name .. "/map",         -- 地图坐标系的名字
  tracking_frame = robot_name .. "/imu_link",-- 将所有传感器数据转换到这个坐标系下
  published_frame = robot_name .. "/odom",  -- tf: map -> footprint
  odom_frame = robot_name .. "/odom",       -- 里程计的坐标系名字
